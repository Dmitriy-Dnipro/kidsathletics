    ...
    <div class="container">
        <div class="event_breadcrumbs">
            ...
            <div class="single_page__row">
                ...
                <div class="single_page__sidebar news_page">
                    <div class="single_sidebar__partners">
                        <p>Cпонсори і партнери</p>
                        <div class="sidebar_partners__slider">
                          <?php 
                            $partners = get_field("gallery_partners", 9);
                            ?>
                            <div class="sidebar_partners__row">
                            <?php foreach($partners as $parnter){?>
                                 <div class="sidebar_partner__slide">
                                     <div class="partner_slide__img">
                                        <img src="<?php echo $parnter['url'];?>" alt="<?php echo $parnter['alt'];?>">
                                    </div>
                                </div>
                                <?}?>
                            </div>
                    ...
                    <div class="more_news__slider">
                        ...
                        <div class="more_news__item">
                            ...
                            <div class="news_item__text">
                                <p><?php the_field("small_description", $news->ID);?></p>
                            </div>
                            <div class="news_item__link">
                                <a href="<?php the_permalink($news->ID);?>">читати більше</a>
                            </div>
                        </div>
                        <?}?>
