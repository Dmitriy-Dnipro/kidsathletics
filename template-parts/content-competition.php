...
<style>
  .competition_page__banner {
    background-image: url("<?php echo get_template_directory_uri();?>/images/competition_page/banner.jpg");
    height: 90vh;
  }
</style>

<section class="page_banner competition_page__banner">
  <div class="container">
    <h2><?php the_title();?></h2>
  </div>
...
<section class="competition_page">
  <div class="container">
    ...
    <div class="competition_descr">
      <p><?php the_field("competition_text", $post_id);?></p>
      <!-- Modal -->
      <div class="competition_modal">
        <div class="modal fade" id="modalCompetition" tabindex="-1" role="dialog" aria-labelledby="modalCompetitionTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body competition_form">
      ...
      <!-- end -->
      <button class="competition_order" data-toggle="modal" data-target="#modalCompetition">Прийняти участь</button>
    </div>

    <div class="competition_target__block">
      <h3 class="title">Цілі і задачі конкурса:</h3>
      <div class="line_box">
        <div class="line red"></div>
        <div class="line blue"></div>
        <div class="line green"></div>
      ...
      <div class="competition_target__box">
        <div class="competition_slider">
          <?php
            $competition_target = get_field("competition_target", $post_id);
            $count = 0;
            foreach($competition_target as $target){
             $count++;
            ?>
            <div class="competition_slider__item">
              <div class="target_text">
                <p><?php echo $target['competition_target_list'];?></p>
              </div>
              <div class="target_number"><?php echo $count;?>.</div>
            </div>
...
<section class="competition_events">
  <div class="container">
    <h3 class="title"><?php the_field("competition_title", $post_id);?></h3>
    <div class="line_box">
      <div class="line red"></div>
      <div class="line blue"></div>
      <div class="line green"></div>
    ...
    <p class="competition_events__descr"><?php the_field("competition_subtitle", $post_id);?></p>
    <div class="row competition_post_slider">

    <?php 
      $competitionArray = array( 'post_type' => 'competitions', 'numberposts' => 6, 'order' => 'DESC');
      $competition_cart = get_posts($competitionArray);

      foreach($competition_cart as $cart){
        $cart_image = get_field("single_competition_image", $cart->ID);
      ?>

      <div class="col-md-4 load_post">
        <div class="coming_events__box-item">
          <div class="box_item__img">
            <img src="<?php echo $cart_image['url'];?>" alt="<?php echo $cart_image['alt'];?>">
          </div>
          <h4 class="cocon-regular">
            <?php the_field("single_competition_title", $cart->ID);?>
          </h4>
          <div class="item_border">
            <h5>
              <?php the_field("single_competition_map", $cart->ID);?>
            </h5>
            ...
            <div class="box_column">
              <div class="box_column-item">
                <p>Дата:</p>
                <p>
                  <?php the_field("single_competition_date", $cart->ID);?>
                </p>
              </div>
              <div class="box_column-item">
                <p>поч.-кінець:</p>
                <p>
                <?php the_field("single_competition_date_start", $cart->ID);?> <?php the_field("single_competition_date_end", $cart->ID);?>
                </p>
            ...
            <div class="box_column-city">
              ...
              <p>
                <?php the_field("single_competition_city", $cart->ID);?>
              </p>
            </div>
            <div class="coming_events__button">
              <a href="<?php the_permalink($cart->ID);?>" class="cocon-regular">Детальніше</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="show_more_gallery"><a>показати більше</a></div>
  </div>
</section>

<section class="competition_gallery">
  <div class="container">
    <h3 class="title">Галерея конкурсів</h3>
    <div class="line_box">
      <div class="line red"></div>
      <div class="line blue"></div>
      <div class="line green"></div>
    ...
    <div class="competition_gallery__box">
    <?php
      $competition_gallery = get_field("competition_gallery", $post_id);
      foreach ($competition_gallery as $gallery) {?>
       <div class="competition_gallery__item">
        <div class="competition_gallery__photo">
...
<script>
  (function ($) {
    ...
    function loadGallery(count) {
      var galleryItems = $('.competition_gallery__item');
    ...
    function loadPosts(count) {
      var postItems = $('.load_post');
      postItems.filter(':hidden').slice(0, count).fadeIn().css('display', 'block');
      var visiblePost = postItems.filter(':visible').length;
      if (postItems.length === visiblePost) {
    ...
    /*show form*/
    // $(".competition_form").hide();
    // $(".competition_order").on("click", function () {
    //   $(".competition_form").slideDown("slow");
    //   $(this).hide();
    // });
    /*end*/
