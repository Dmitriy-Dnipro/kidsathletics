...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-136797045-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-136797045-1');
</script>

	<meta name="google-site-verification" content="LCIv1kM9whX7ZOYKT4SUJ9i9BwQxSfUzl-pcTXEf5y8" />
    ...
    <header class="header_page">
        <div class="container-flex">
            <div class="header_box">
                ...
                <div class="header_box__menu">
                    <?php wp_nav_menu( array( 'container_class' => 'menu-header', 'theme_location' => 'header' ) ); ?>
                </div>
                <div class="header_box__company">
                    <div class="company_slider">
                        <?php 
                            $header_info_parnter = get_field("header_info_parnter", 9);
                            foreach($header_info_parnter as $header_partner){?>
                            <div class="company_slider__item">
                                <p><?php echo $header_partner['header_info_parnter__name'];?></p>
                                <div class="company-line"></div>
                                <img src="<?php echo $header_partner['header_info_parnter__logo']['url'];?>" alt="<?php echo $header_partner['header_info_parnter__logo']['alt'];?>">
                            </div>
                        <?}?>
                    </div>
                </div>
                <div class="header_box__burgerMenu">
                ...
                <div id="main_menu">
                    <div class="main_menu_bg">
                        <div class="container-flex">
                            <div class="lang_nav">
                                ...
                                <div class="lang_menu">
                                    <!-- <a href="#" class="active_lang_menu">UA</a>
                                    <a href="#">ENG</a> -->
                    ...
                    <div class="container-flex">
                        ...
                        <?php wp_nav_menu( array( 'container_class' => 'main_menu__nav', 'theme_location' => 'header-main' ) ); ?>
                            ...
                            <a href="#"><svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <radialGradient id="rg" r="150%" cx="30%" cy="107%">
                                    ...
                                    <path d="M36.4 13H15.6C14.17 13 13 14.17 13 15.6V36.4C13 37.83 14.17 39 15.6 39H36.4C37.83 39 39 37.83 39 36.4V15.6C39 14.17 37.83 13 36.4 13ZM26 20.8C28.86 20.8 31.2 23.14 31.2 26C31.2 28.86 28.86 31.2 26 31.2C23.14 31.2 20.8 28.86 20.8 26C20.8 23.14 23.14 20.8 26 20.8ZM16.25 36.4C15.86 36.4 15.6 36.14 15.6 35.75V24.7H18.33C18.2 25.09 18.2 25.61 18.2 26C18.2 30.29 21.71 33.8 26 33.8C30.29 33.8 33.8 30.29 33.8 26C33.8 25.61 33.8 25.09 33.67 24.7H36.4V35.75C36.4 36.14 36.14 36.4 35.75 36.4H16.25ZM36.4 18.85C36.4 19.24 36.14 19.5 35.75 19.5H33.15C32.76 19.5 32.5 19.24 32.5 18.85V16.25C32.5 15.86 32.76 15.6 33.15 15.6H35.75C36.14 15.6 36.4 15.86 36.4 16.25V18.85Z"
                                        fill="#1C1C1C" />
                                    <rect x="1.5" y="1.5" width="48" height="48" rx="8.5" stroke="#1C1C1C" stroke-width="3" />
                                </svg></a>
