        ...
        <div class="footer_content">
            <div class="container">
                <div class="footer_social">
                    <p>Приєднуйтесь!</p>
                    <div class="footer_social__link">
                        <a href="#" class="inst"><svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <radialGradient id="rg" r="150%" cx="30%" cy="107%">
                                ...
                                <path d="M36.4 13H15.6C14.17 13 13 14.17 13 15.6V36.4C13 37.83 14.17 39 15.6 39H36.4C37.83 39 39 37.83 39 36.4V15.6C39 14.17 37.83 13 36.4 13ZM26 20.8C28.86 20.8 31.2 23.14 31.2 26C31.2 28.86 28.86 31.2 26 31.2C23.14 31.2 20.8 28.86 20.8 26C20.8 23.14 23.14 20.8 26 20.8ZM16.25 36.4C15.86 36.4 15.6 36.14 15.6 35.75V24.7H18.33C18.2 25.09 18.2 25.61 18.2 26C18.2 30.29 21.71 33.8 26 33.8C30.29 33.8 33.8 30.29 33.8 26C33.8 25.61 33.8 25.09 33.67 24.7H36.4V35.75C36.4 36.14 36.14 36.4 35.75 36.4H16.25ZM36.4 18.85C36.4 19.24 36.14 19.5 35.75 19.5H33.15C32.76 19.5 32.5 19.24 32.5 18.85V16.25C32.5 15.86 32.76 15.6 33.15 15.6H35.75C36.14 15.6 36.4 15.86 36.4 16.25V18.85Z"
                                     />
                                <rect x="1.5" y="1.5" width="48" height="48" rx="8.5" stroke-width="3" />
                            </svg></a>
                        <a href="https://www.facebook.com/kidsathleticsdnepr/" class="facebook" target="_blank"><svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" class="youtube"><svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="footer_company">
                    <div class="comapny">
                        <p><span class="text-bold">©2019 ФЛАДнО</span><br>Дитяча легка атлетика за програмою
                            <span class="text-upper">IAAF</span></p>
                    </div>
                ...
                <div class="footer_private">
                    <div class="footer_private__rights">
                        <a href="javascript:void(0);">Всi права захищенi-<?php echo date('Y');?></a>
                    </div>
                    <div class="footer_private__politics">
                        <a href="<?php home_url();?>/privacy-policy">Полiтика конфiденцiйностi</a>
                    </div>

                    <div class="footer_private__idea">
                        <a href="https://ideadigital.agency/" target="_blank">Розробка сайту: <span>IdeaDigital.Agency</span></a>
                    </div>
                </div>
